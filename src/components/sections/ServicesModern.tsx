...
function CursorFollower({ isVisible, mouseX, mouseY }: { isVisible: boolean; mouseX: number; mouseY: number }) {
  ...
  return (
    ...
    >
      <div className="w-20 h-20 rounded-full bg-primary flex items-center justify-center">
        <span className="text-primary-foreground text-xs font-medium tracking-wide">View</span>
      </div>
    </motion.div>
  );
}
...
export function ServicesModern() {
  ...
  return (
    <>
      <CursorFollower isVisible={cursorVisible} mouseX={mousePos.x} mouseY={mousePos.y} />
      ...
      >
        ...
        <div className="container-wide relative z-10">
          ...
          >
            ...
            >
              <motion.div 
                className="w-6 h-6 rounded-full border border-primary/50 flex items-center justify-center"
                whileHover={{ scale: 1.1, borderColor: "hsl(4, 84%, 49%)" }}
            ...
            >
              <span className="text-primary/60 text-lg font-light">({servicesData.length})</span>
            </motion.div>
          </motion.div>
          ...
          >
            {servicesData.map((service, index) => (
              ...
              >
                ...
                <div
                  className="relative py-6 lg:py-8 cursor-none"
                    ...
                    <div className="col-span-8 lg:col-span-10">
                      <AnimatePresence mode="wait" initial={false}>
                        {expandedId === service.id ? (
                          ...
                          >
                            <motion.h3
                              className="font-syne text-xl lg:text-2xl xl:text-3xl font-semibold"
                              animate={{ 
                                x: hoveredId === service.id ? 12 : 0,
                                color: hoveredId === service.id ? "hsl(4, 84%, 65%)" : "rgba(255,255,255,1)"
                              }}
